...
# Detect charger plugged or not
if [ "$status" = "Charging" ]; then
    echo -e "    Charger: ${GREEN}Plugged In 🔌${NC}"
elif [ "$status" = "Discharging" ]; then
    echo -e "    Charger: ${RED}Not Plugged In 🔋${NC}"
elif [ "$status" = "Full" ]; then
    echo -e "    Charger: ${GREEN}Fully Charged ⚡${NC}"
else
    echo "    Charger: Unknown"
fi
...
echo "    No battery detected (Desktop / Virtual Machine)"
fi
